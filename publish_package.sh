...
dotnet nuget push src/ZMap/bin/Release/*.nupkg --source $NUGET_SERVER --api-key $NUGET_KEY --skip-duplicate 
dotnet nuget push src/ZMap.Renderer.SkiaSharp/bin/Release/*.nupkg   --source $NUGET_SERVER --api-key $NUGET_KEY --skip-duplicate 
dotnet nuget push src/ZMap.Source.Postgre/bin/Release/*.nupkg   --source $NUGET_SERVER --api-key $NUGET_KEY --skip-duplicate 
dotnet nuget push src/ZMap.Source.ShapeFile/bin/Release/*.nupkg --source $NUGET_SERVER --api-key $NUGET_KEY --skip-duplicate 
