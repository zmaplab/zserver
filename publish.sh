...
docker buildx build --platform linux/arm64 --target zserver-api -f API_ARM.Dockerfile -t zlzforever/zserver-api:arm64-20221210 .
docker push zlzforever/zserver-api:arm64-20221110