...
{
    private const string User32FileName = "user32.dll";
    ...
    [DllImport(User32FileName, CallingConvention = CallingConvention.Winapi, SetLastError = true,
    ...
    [DllImport(User32FileName, CallingConvention = CallingConvention.Winapi)]
