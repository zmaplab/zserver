...
internal class Cgl
{
    ...
    private const string libCGL = "/System/Library/Frameworks/ApplicationServices.framework/ApplicationServices";
    ...
    [DllImport(libGL)]
    public static extern CGLError CGLChoosePixelFormat([In] CGLPixelFormatAttribute[] attribs, out IntPtr pix,
        out int npix);
