...
internal class Wgl
{
    private const string Opengl32FileName = "opengl32.dll";
    ...
    static Wgl()
    {
        ...
        wglGetExtensionsStringARB =
            wglGetProcAddress<wglGetExtensionsStringARBDelegate>("wglGetExtensionsStringARB");
    ...
    [DllImport(Opengl32FileName, CallingConvention = CallingConvention.Winapi)]
