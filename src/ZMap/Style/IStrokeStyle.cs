...
public interface IStrokeStyle
{
    ...
    CSharpExpression<int?> Gradient { get; set; }
    CSharpExpression<int?> Blur { get; set; }
    CSharpExpression<int?> Offset { get; set; }
    CSharpExpression<int?> GapWidth { get; set; }
    CSharpExpression<TranslateAnchor> TranslateAnchor { get; set; }
    CSharpExpression<double[]> Translate { get; set; }
    CSharpExpression<string> Pattern { get; set; }
}