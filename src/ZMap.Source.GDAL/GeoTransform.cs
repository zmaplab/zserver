...
namespace ZMap.Source.GDAL
{
    ...
    internal class GeoTransform
    {
        ...
        /// Constructor
        /// </summary>
        public GeoTransform(double offsetX, double offsetY, double pixelSizeX = 1, double pixelSizeY = -1,
        ...
        public GeoTransform(double[] transform)
        {
            if (transform.Length < 6)
                throw new ArgumentException("GeoTransform constructor invoked with invalid sized array",
                    nameof(transform));
